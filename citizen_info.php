  ...
  * {
  ...
  <body>
    ...
    if (isset($_POST['search'])){
      ...
      include 'includes/db.inc.php';
      if($account=='admin'){
          $sql = "SELECT *, CONCAT(first_name,' ', last_name) AS fname FROM personal_information WHERE barangay_id LIKE '%$searchq%' OR fname LIKE '%$searchq%' OR barangay LIKE '%$searchq%' OR house_no LIKE '%$searchq%' OR street LIKE '%$searchq%' OR no_of_members LIKE '%$searchq%' OR family_code LIKE '%$searchq%' OR username LIKE '%$searchq%' ORDER BY barangay_id ASC;";
        }
        else{
          $sbv =$_SESSION['sb'];
          $sql = "SELECT *, CONCAT(first_name,' ', last_name) AS fname FROM personal_information WHERE barangay = '$sbv' AND (barangay_id LIKE '%$searchq%' OR fname LIKE '%$searchq%' OR house_no LIKE '%$searchq%' OR street LIKE '%$searchq%' OR no_of_members LIKE '%$searchq%' OR family_code LIKE '%$searchq%' OR username LIKE '%$searchq%') ORDER BY barangay_id ASC;";
        }
        echo "<div id='t1'>";
