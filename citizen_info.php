  ...
  <body>
    ...
    if (isset($_POST['search'])){
      ...
      if($account=='admin'){
          ...
          $sbv =$_SESSION['sb'];
          $sql = "SELECT *, CONCAT(first_name,' ', last_name) FROM personal_information WHERE barangay = '$sbv' AND (barangay_id LIKE '%$searchq%' OR CONCAT(first_name,' ', last_name) LIKE '%$searchq%' OR house_no LIKE '%$searchq%' OR street LIKE '%$searchq%' OR no_of_members LIKE '%$searchq%' OR family_code LIKE '%$searchq%' OR username LIKE '%$searchq%') ORDER BY barangay_id ASC;";
        }
        echo "<div id='t1'>";
...
<div class="container">
      ...
      <div class="card lg-4 light-sm" style='margin:auto'>
