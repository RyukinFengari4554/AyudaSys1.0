...
<head>
  ...
  <title>AyudaSys Failed Verification</title>
...
<section id="d1">
  ...
  <section id="d2">
  <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    <h1 class="display-4">Nabigong Pagpaparehistro!</h1>
    <p class="lead">Maling Impormasyon o Hindi Nahanap ang Datos!<br> Pakiusap na paulit ang pagrerehistro!</p>
  </div>
  <div class="hello">
  </div>
  <div class="hello">
