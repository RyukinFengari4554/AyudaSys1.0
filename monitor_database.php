...
<body>
  ...
  <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    <h1 class="display-4">Monitor Database Page</h1>
    <p class="lead">The Monitor Database Page allows for monitoring of the database tables</p>
  </div>
  ...
  <div class="container">
    <div class="card-deck  text-center">
      ...
      <div class="card light-sm">
        <a href="manage_necessity.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Show Ayuda
            <br>Packages List<List></List></button></a>
      </div>
      <div class="card  light-sm">
